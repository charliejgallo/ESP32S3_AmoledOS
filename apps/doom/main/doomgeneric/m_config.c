...
{
    /* AmoledOS: <card>/doom/, with its trailing slash */
    return strdup(dg_data_dir());
}
...
char *M_GetSaveGameDir(char *iwadname)
{
    ...
    else
    {
        ...
        free(topdir);
#else
        /* AmoledOS: no dot-folders (the portal hides them) and no double slash */
        savegamedir = M_StringJoin(configdir, "saves/", NULL);
